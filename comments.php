...
// Do not delete these lines
	...
	if ( post_password_required() ) { ?>
		<p class="nocomments">Detta inlägg är lösenordsskyddad. Skriv in lösenord för att se kommentarer.</p>
	<?php
		return;
	}
?>
...
<h3><?php comment_form_title( 'Kommentera', 'Kommentera %s' ); ?></h3>
...
<p>Du måste vara <a href="<?php echo wp_login_url( get_permalink() ); ?>">inlogggad</a> för att publicera kommentarer.</p>
<?php else : ?>
...
<label for="author"><small>Namn <?php if ($req) echo "(obligatorisk)"; ?></small></label></p>

<p><input type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
<label for="email"><small>E-post (kommer inte visas p&aring; sidan) <?php if ($req) echo "(obligatorisk)"; ?></small></label></p>
